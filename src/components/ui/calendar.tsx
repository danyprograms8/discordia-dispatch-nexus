  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center bg-white dark:bg-gray-800",
        ...
        day_today: "bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white border border-purple-500",
        day_outside:
